...
```{r}
plot(1:3, alb6$results$real[2:4,1], xlab="Tempo", ylab="Gamma''",
...
```{r}
plot(2:3, alb6$results$real[5:6,1], xlab="Tempo", ylab="Gamma'",
...
```{r}
tempo <- 1:4 -0.05
plot(tempo, alb6$results$derived[,1], xlab="Tempo", ylab="N",
